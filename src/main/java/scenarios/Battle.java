        ...
        for (int i = 0; i < numEncounters; i++) {
            ...
            switch (randomEncounter) {
                ...
                case 4 -> System.out.println("""
                        ...
                        The clerics had fought bravely, but being outnumbered even the temple fell eventuallyAs you approach the temple, the corpses of the clerics arise and ambush you.
                        Roll Initiative!
                        """);
                default -> System.out.println("You encounter nothing unusual.");
            }
